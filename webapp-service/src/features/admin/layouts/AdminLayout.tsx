...
const navItems: NavItem[] = [
    ...
    },
    {
        ...
        icon: Settings,
        children: [
            {label: 'Payment Plans', icon: CreditCard, href: '/admin/config/plans'},
...
const AdminLayout: React.FC<AdminLayoutProps> = ({children}) => {
    ...
    const [openMenus, setOpenMenus] = useState<string[]>(['User Management', 'Business Objects', 'System Configuration']);
